...
const LandingPage = () => {
    ...
    return (
        <div className="relative w-full h-screen bg-gradient-to-b from-[rgba(41,64,38,1)] via-[rgba(41,64,38,0.5)] via-10% to-20% to-[rgba(0,0,0,0)]">
            <Navbar/>
            <section id="home" className="relative lg:min-h-screen min-w-full">
                <img className="lg:absolute top-0 left-0 w-full md:h-full z-[-1]" src={HeroImg} alt="Gambar orang berenang" />
                <div className="h-[4rem] w-full bg-gradient-to-t from-white from-40% to-[rgba(0,0,0,0)] absolute bottom-0"></div>
            </section>
            <section className="bg-white flex flex-col items-center pt-[2rem] lg:pt-[7rem] pb-[2rem] lg:pb-[4rem]">
                <div className="w-[80%] flex flex-col gap-4 lg:gap-[4rem] items-center">
                    <h1 className="text-4xl font-bold">Wisata</h1>
                    <div className="lg:flex w-full lg:justify-between gap-14 grid grid-cols-2">
            ...
            <section id="about" className="bg-[#F2F6F6] flex justify-center w-full relative">
                <img src={logo} className="opacity-40 absolute z-[1] w-[70%] lg:w-[42rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                <div className="w-[70%] lg:w-[50%] pt-8 pb-8 lg:pt-10 flex flex-col justify-between lg:pb-32 text-center gap-4 lg:gap-32">
                    <h1 className="text-2xl lg:text-4xl font-bold">Tentang Kami</h1>
                    <div className="text-base lg:text-3xl font-semibold text-justify tracking-tight">
            ...
            <section id="news" className="flex justify-center p-10">
                <div className="lg:w-[70%] flex flex-col items-center gap-10">
                    <div className="text-[#646464] flex flex-col items-center gap-2 w-full">
                        <h1 className="text-xl lg:text-4xl font-bold">Maps dan Peta Wisata</h1>
                        <p className="text-lg lg:text-2xl">Easy and Fast</p>
                    </div>
                    <div className="flex gap-10 flex-col lg:grid lg:grid-cols-2">
                        <div className="flex justify-center items-center">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3949.76638083046!2d113.83630099999999!3d-8.1252517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd6bf8fb6e97339%3A0x6ce61ee74b7fe29a!2sBendung%20Kembar!5e0!3m2!1sid!2sid!4v1722354994101!5m2!1sid!2sid"className="w-[90%] h-[100%] lg:w-[35rem] lg:h-[27rem]" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                        <div className="flex justify-between flex-col gap-2 items-center">
                            <div className="font-bold bg-[#285B0A] w-fit py-2 lg:py-3 px-4 lg:px-5 rounded-2xl text-white text-lg lg:text-2xl">
                                <p>Scan Untuk Menjelajah</p>
                            </div>
                            <img src={QRImg} className="w-[80%] lg:w-[23rem]" />
                        </div>
                    </div>
                    <Anchor>Unduh Dena Wisata</Anchor>
                </div>
            </section>
            <section id="feature" className="flex justify-center p-8 lg:p-20">
                <div className="bg-[#F9F9FF] w-[90%] flex flex-col gap-6 py-8 items-center justify-center">
                    <div className="w-[80%] lg:w-[50%] text-center flex flex-col items-center gap-3">
                        <h1 className="text-2xl lg:text-4xl text-[#285B0A] font-bold">Informasi FoodCourt</h1>
                    ...
                    <div className="flex justify-center w-[80%]">
                        <div className="lg:grid lg:grid-cols-3 flex flex-col w-full h-full gap-5 lg:min-h-[25rem]">
            ...
            <section id="service" className="w-full flex flex-col gap-12 relative h-[20rem] lg:h-[42rem] p-[1rem] lg:p-[5rem] bg-[#E6F7EE] overflow-hidden">
                <div className="flex w-full flex-col items-center h-[10%]">
                    <h1 className="text-2xl lg:text-4xl">Apa Kata Mereka</h1>
                    <h1 className="text-lg lg:text-2xl">Tentang Wisata</h1>
                </div>
                <div className="w-full h-full">
                    <Slider />
                </div>
            </section>
            <section className="w-full flex justify-center p-[2rem] lg:p-[4rem]">
                <div className="w-[90%] lg:w-[80%] flex flex-col items-center relative gap-8 lg:gap-14">
                    <img src={PlaneImg} className="absolute top-0 right-0 w-6 lg:w-16" alt="" />
                    <div className=" flex flex-col gap-4 lg:w-[60%] items-center text-center">
                        <h1 className="font-semibold text-2xl lg:text-4xl">Saran dan Kritik</h1>
                        <p className="font-bold text-xs lg:text-base">Yuk berikan kritik dan saran Atas tempat wisata ini agar  menjadi lebih baik lagi, jangan lupa berikan kritik dan saran yang membangun ya.</p>
                    </div>
            ...
            <footer className="p-14 flex justify-center text-white bg-[#263238] items-start">
                <div className="w-[80%] flex flex-col lg:flex-row gap-12 lg:gap-96">
                    <div className="gap-5 flex flex-col items-start">
                        <div className="flex flex-col items-start justify-center ">
                            <div className="flex gap-5 items-center">
                                <img src={logo} className="w-32 lg:w-44" alt="" />
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            <div className="p-1 lg:p-2 rounded-full bg-[#3B464C] lg:w-10 lg:h-10 h-6 w-6">
                            ...
                            <a href="https://www.youtube.com/live/f0QGjJyZNsg?feature=shared" className="p-1 lg:p-2 rounded-full bg-[#3B464C] lg:w-10 lg:h-10 h-6 w-6">
                    ...
                    <div className="flex flex-col lg:flex-row lg:gap-8 gap-4 w-[60%]">
                        <div className="flex flex-col items-start gap-2 lg:gap-8">
                            <p className="text-lg font-semibold">Company</p>
                            <ul className="flex flex-col items-start lg:gap-5">
                                <li>About us</li>
                                <li>Blog</li>
                                <li>Contact us</li>
                                <li>Pricing</li>
